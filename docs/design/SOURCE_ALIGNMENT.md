...
| Common DB alignment | [`docs/operations/COMMON_DB_ALIGNMENT.md`](../operations/COMMON_DB_ALIGNMENT.md), [GitHub issue #147](https://github.com/watchout/agent-memory/issues/147) | Phase 0 contract for common DB discovery, common-registry adapter boundaries, product-table ownership, drift evidence, and protected review gates. |
