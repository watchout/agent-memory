...
- `KUSABI_V2_API_CLI_CONTRACT.md` — canonical CLI registry, versioned envelopes, the closed typed-error registry and validation order, and per-command payload/result contracts.
...
- `KUSABI_V2_DONE_DEFINITION.md` — the binary D01-D14 gates that decide v2_done, and the content-addressed evidence each one requires.
...
- `KUSABI_V2_UAMP_FIXTURE_CATALOG.md` — draft UAMP fixture catalog; no fixture files, runner, or conformance claim.
...
- UAMP fixture catalog work remains planning-only until fixture files, runner, reports, and owner-reviewed evidence exist.
