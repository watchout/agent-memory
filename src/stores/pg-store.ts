...
const MIGRATIONS = [
  ...
  `INSERT INTO recovery_config (agent_id, max_tokens, decisions_limit, messages_limit, knowledge_limit, discord_history_limit, discord_channels, restart_message_threshold) VALUES
    ('cto', 3000, 5, 10, 5, 20, '{1485598480553611357,1486097810989383773}', 100),
    ('iyasaka-arc', 2000, 3, 10, 3, 10, '{1485598480553611357}', 150),
    ('hotel-dev', 1000, 0, 5, 3, 5, '{1486097810989383773}', 80),
    ('adf-dev', 1000, 0, 5, 3, 5, '{1486161338832126083}', 80)
